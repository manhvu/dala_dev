defmodule DalaDev.OtpDownloader do
  ...
  @base_url "https://github.com/ohhi-vn/dala/releases/download/#{@release_tag}"
        ...
        {:error,
         DalaDev.Error.new(
           ...
           "OTP extraction produced no erts-* directory in #{dir}.\\n" <>
             ...
             "       Run `mix dala.doctor` for diagnosis, or report at https://github.com/ohhi-vn/dala/issues"
         )}
    end
  end
end
